/*
* execute_filter() -> This function executes the filtration of the input array on the specified index chunk
...
*   - None
*/
function execute_filter(input_array, filter_array, input_func, index_start, index_end)
{
    for (let i = index_start; i < index_end; i++)
    {
        const val = input_array[i];
        filter_array[i] = input_func(val);
    }
}
...
onmessage = function (event) {
    ...
    while (true)
    {
        ...
        execute_filter(input_array, filter_array, input_func, index_start, index_end);
    }
